...
icon = Image.open(r"D:\\GUVI\\phonepe\\Phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Khizar Hussain",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Khizar Hussain*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"D:\\GUVI\\phonepe\\Statenames.csv")
            df1.State = df2
